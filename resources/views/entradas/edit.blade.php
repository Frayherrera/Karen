...
<div class="container mx-auto px-4">
    ...
    <form action="{{ route('articulos.update', $articulo->id) }}" method="POST" class="bg-white p-6 rounded shadow-md">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="valor_costo" id="valor_costo" value="{{ old('valor_costo', $articulo->valor_costo) }}" step="0.01" 
                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
        </div>
        <div class="mb-4">
            <label for="valor_venta" class="block text-sm font-medium text-gray-700">Valor Venta</label>
            <input type="number" name="valor_venta" id="valor_venta" value="{{ old('valor_venta', $articulo->valor_venta) }}" step="0.01" 
                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
        </div>
        <div class="mb-4">
        ...
        <div class="flex justify-end">
            <a href="{{ route('articulos.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white py-2 px-4 rounded mr-2">Cancelar</a>
